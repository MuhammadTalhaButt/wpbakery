...
// Element Class
class vc_day_one_link_button extends WPBakeryShortCode {

    // Element Init
    function __construct() {
        add_action( 'init', array( $this, 'vc_day_one_link_button_mapping' ) );
        add_shortcode( 'vc_day_one_link_button', array( $this, 'vc_day_one_link_button_html' ) );
    }

    // Element Mapping
    public function vc_day_one_link_button_mapping() {
        ...
        vc_map(
            ...
            array(
                'name' => __('Day One Button', 'day-one'),
                'base' => 'vc_day_one_link_button',
                //'description' => __('Navigation and Search for Top Header', 'day-one'),
                'category' => __('Day One Tech', 'day-one'),
    ...
    // Element HTML
    public function vc_day_one_link_button_html( $atts ) {
